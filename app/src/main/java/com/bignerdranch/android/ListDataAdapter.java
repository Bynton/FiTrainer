...
public class ListDataAdapter extends ArrayAdapter {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        if(row == null) {
            ...
            layoutHandler.AGE = (TextView)row.findViewById(R.id.text_age);
            layoutHandler.WEIGHT = (TextView)row.findViewById(R.id.text_weight);
            layoutHandler.GOAL = (TextView)row.findViewById(R.id.text_goal);
        ...
        layoutHandler.GOAL.setText(dataProvider.getGoal());
        return row;
    }
}
